...
public interface HoodieTimeline extends Serializable {
  ...
  String INDEXING_EXTENSION = "." + INDEXING_ACTION;
  ...
  String INFLIGHT_INDEXING_EXTENSION = "." + INDEXING_ACTION + INFLIGHT_EXTENSION;
  String REQUESTED_INDEXING_EXTENSION = "." + INDEXING_ACTION + REQUESTED_EXTENSION;
