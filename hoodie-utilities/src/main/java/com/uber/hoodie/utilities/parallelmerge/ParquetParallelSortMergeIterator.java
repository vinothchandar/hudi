 ...
 */
public class ParquetParallelSortMergeIterator implements Iterator<IndexedRecord> {
  ...
  public ParquetParallelSortMergeIterator(String mergeKey, List<ParquetReaderIterator<IndexedRecord>> iterators) {
    ...
    iterators.forEach(i -> {
      if (i.hasNext()) {
        ...
        holder.iterator = new BufferedIterator(i, 10000);
